...
func TestRegisterData_RevertSplit(t *testing.T) {
	...
	require.ErrorIs(t, err, txsystem2.ErrStateContainsUncommittedChanges)
...
func createStateAndTxSystem(t *testing.T) (*state.State, *txsystem2.GenericTxSystem, abcrypto.Signer) {
