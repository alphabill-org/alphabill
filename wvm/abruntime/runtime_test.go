...
func TestCheckProgram(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := CheckProgram(tt.args.ctx, tt.args.src, tt.args.execCtx, obs.Logger())
			if tt.wantErrStr != "" {
...
func TestCall(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := Call(tt.args.ctx, tt.args.src, tt.args.fName, tt.args.execCtx, tt.args.storage, obs.Logger())
			if tt.wantErrStr != "" {
				require.ErrorContains(t, err, tt.wantErrStr)
			} else {
				require.NoError(t, err)
