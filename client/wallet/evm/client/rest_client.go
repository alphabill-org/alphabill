...
/*
New creates REST API abclient for token wallet backend. The "abAddr" is
...
// abclient needs a general refactoring - it should be possible to add a generic abclient and not have everything together
