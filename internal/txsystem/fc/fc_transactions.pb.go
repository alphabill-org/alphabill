...
func (x *CloseFCOrder) Reset() {
	*x = CloseFCOrder{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fc_transactions_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CloseFCOrder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloseFCOrder) ProtoMessage() {}

func (x *CloseFCOrder) ProtoReflect() protoreflect.Message {
	mi := &file_fc_transactions_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloseFCOrder.ProtoReflect.Descriptor instead.
func (*CloseFCOrder) Descriptor() ([]byte, []int) {
	return file_fc_transactions_proto_rawDescGZIP(), []int{2}
}

func (x *CloseFCOrder) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *CloseFCOrder) GetTargetUnitId() []byte {
	if x != nil {
...
func (x *CloseFCOrder) GetNonce() []byte {
	if x != nil {
		return x.Nonce
	}
	return nil
...
func (x *ReclaimFCOrder) Reset() {
	*x = ReclaimFCOrder{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fc_transactions_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReclaimFCOrder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReclaimFCOrder) ProtoMessage() {}

func (x *ReclaimFCOrder) ProtoReflect() protoreflect.Message {
	mi := &file_fc_transactions_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReclaimFCOrder.ProtoReflect.Descriptor instead.
func (*ReclaimFCOrder) Descriptor() ([]byte, []int) {
	return file_fc_transactions_proto_rawDescGZIP(), []int{3}
}

func (x *ReclaimFCOrder) GetCloseFeeCreditTransfer() *txsystem.Transaction {
	if x != nil {
...
func (x *ReclaimFCOrder) GetCloseFeeCreditProof() *block.BlockProof {
	if x != nil {
...
func (x *ReclaimFCOrder) GetBacklink() []byte {
	if x != nil {
		return x.Backlink
	}
	return nil
...
var file_fc_transactions_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x74, 0x78, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2f,
	0x66, 0x63, 0x3b, 0x66, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_fc_transactions_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_fc_transactions_proto_goTypes = []interface{}{
	(*TransferFCOrder)(nil),      // 0: TransferFCOrder
	(*AddFCOrder)(nil),           // 1: AddFCOrder
	(*CloseFCOrder)(nil),         // 2: CloseFCOrder
	(*ReclaimFCOrder)(nil),       // 3: ReclaimFCOrder
	(*txsystem.Transaction)(nil), // 4: Transaction
	(*block.BlockProof)(nil),     // 5: BlockProof
}
var file_fc_transactions_proto_depIdxs = []int32{
	4, // 0: AddFCOrder.fee_credit_transfer:type_name -> Transaction
	5, // 1: AddFCOrder.fee_credit_transfer_proof:type_name -> BlockProof
	4, // 2: ReclaimFCOrder.close_fee_credit_transfer:type_name -> Transaction
	5, // 3: ReclaimFCOrder.close_fee_credit_proof:type_name -> BlockProof
...
func file_fc_transactions_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fc_transactions_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloseFCOrder); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_fc_transactions_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReclaimFCOrder); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
