...
var file_atomic_broadcast_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x4e, 0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65,
	...
	0x74, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x69,
...
var file_atomic_broadcast_proto_goTypes = []interface{}{
	...
	(*ProposalMsg)(nil),             // 12: ProposalMsg
	(*VoteMsg)(nil),                 // 13: VoteMsg
	(*TimeoutMsg)(nil),              // 14: TimeoutMsg
...
var file_atomic_broadcast_proto_depIdxs = []int32{
	...
	7,  // 12: ProposalMsg.block:type_name -> BlockData
	6,  // 13: ProposalMsg.high_commit_qc:type_name -> QuorumCert
	11, // 14: ProposalMsg.last_round_tc:type_name -> TimeoutCert
	4,  // 15: VoteMsg.vote_info:type_name -> VoteInfo
	5,  // 16: VoteMsg.ledger_commit_info:type_name -> LedgerCommitInfo
	6,  // 17: VoteMsg.high_commit_qc:type_name -> QuorumCert
	9,  // 18: VoteMsg.timeout_signature:type_name -> TimeoutWithSignature
	8,  // 19: TimeoutMsg.timeout:type_name -> Timeout
...
func file_atomic_broadcast_proto_init() {
	...
	file_atomic_broadcast_proto_msgTypes[10].OneofWrappers = []interface{}{}
