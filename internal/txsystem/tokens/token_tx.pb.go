...
type Icon struct {
	...
	// the MIME content type identifying an image format;
	Type string `protobuf:"bytes,1,opt,name=type,proto3" json:"type,omitempty"`
	// the image in the format specified by type;
...
type CreateNonFungibleTokenTypeAttributes struct {
	...
	// the symbol (short name) of this token type; note that the symbols are not guaranteed to be unique;
	Symbol string `protobuf:"bytes,1,opt,name=symbol,proto3" json:"symbol,omitempty"`
	// the long name of this token type;
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// the icon of this token type;
	...
	ParentTypeId []byte `protobuf:"bytes,4,opt,name=parent_type_id,json=parentTypeId,proto3" json:"parent_type_id,omitempty"`
	// the predicate clause that controls defining new sub-types of this type;
	SubTypeCreationPredicate []byte `protobuf:"bytes,5,opt,name=sub_type_creation_predicate,json=subTypeCreationPredicate,proto3" json:"sub_type_creation_predicate,omitempty"`
	// the predicate clause that controls creating new tokens of this type
	TokenCreationPredicate []byte `protobuf:"bytes,6,opt,name=token_creation_predicate,json=tokenCreationPredicate,proto3" json:"token_creation_predicate,omitempty"`
	...
	InvariantPredicate []byte `protobuf:"bytes,7,opt,name=invariant_predicate,json=invariantPredicate,proto3" json:"invariant_predicate,omitempty"`
	// the clause that all tokens of this type (and of sub-types of this type) inherit into their data update predicates
	DataUpdatePredicate []byte `protobuf:"bytes,8,opt,name=data_update_predicate,json=dataUpdatePredicate,proto3" json:"data_update_predicate,omitempty"`
	// inputs to satisfy the sub-type creation predicates of all parents.
	SubTypeCreationPredicateSignatures [][]byte `protobuf:"bytes,9,rep,name=sub_type_creation_predicate_signatures,json=subTypeCreationPredicateSignatures,proto3" json:"sub_type_creation_predicate_signatures,omitempty"`
}
...
func (x *CreateNonFungibleTokenTypeAttributes) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateNonFungibleTokenTypeAttributes) GetIcon() *Icon {
	if x != nil {
		return x.Icon
	}
	return nil
...
type MintNonFungibleTokenAttributes struct {
	...
	TokenCreationPredicateSignatures [][]byte `protobuf:"bytes,7,rep,name=token_creation_predicate_signatures,json=tokenCreationPredicateSignatures,proto3" json:"token_creation_predicate_signatures,omitempty"`
}
...
func (x *MintNonFungibleTokenAttributes) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type CreateFungibleTokenTypeAttributes struct {
	...
	// identifies the parent type that this type derives from; 0 indicates there is no parent type;
	ParentTypeId []byte `protobuf:"bytes,4,opt,name=parent_type_id,json=parentTypeId,proto3" json:"parent_type_id,omitempty"`
	// the number of decimal places to display for values of tokens of the new type;
	DecimalPlaces uint32 `protobuf:"varint,5,opt,name=decimalPlaces,proto3" json:"decimalPlaces,omitempty"`
	// the predicate clause that controls defining new sub-types of this type;
	SubTypeCreationPredicate []byte `protobuf:"bytes,6,opt,name=sub_type_creation_predicate,json=subTypeCreationPredicate,proto3" json:"sub_type_creation_predicate,omitempty"`
	// the predicate clause that controls creating new tokens of this type
	TokenCreationPredicate []byte `protobuf:"bytes,7,opt,name=token_creation_predicate,json=tokenCreationPredicate,proto3" json:"token_creation_predicate,omitempty"`
	// the invariant predicate clause that all tokens of this type (and of sub- types of this type) inherit into their bearer predicates;
	InvariantPredicate []byte `protobuf:"bytes,8,opt,name=invariant_predicate,json=invariantPredicate,proto3" json:"invariant_predicate,omitempty"`
	// inputs to satisfy the sub-type creation predicates of all parents.
	SubTypeCreationPredicateSignatures [][]byte `protobuf:"bytes,9,rep,name=sub_type_creation_predicate_signatures,json=subTypeCreationPredicateSignatures,proto3" json:"sub_type_creation_predicate_signatures,omitempty"`
}
...
func (x *CreateFungibleTokenTypeAttributes) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateFungibleTokenTypeAttributes) GetIcon() *Icon {
	if x != nil {
		return x.Icon
	}
	return nil
...
func (x *JoinFungibleTokenAttributes) Reset() {
	*x = JoinFungibleTokenAttributes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_token_tx_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*JoinFungibleTokenAttributes) Descriptor() ([]byte, []int) {
	return file_token_tx_proto_rawDescGZIP(), []int{10}
}
...
var file_token_tx_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2e, 0x0a, 0x04, 0x49,
	...
	0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd9, 0x03, 0x0a, 0x24,
	...
	,
	...
	0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x6e, 0x66, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x6e, 0x66, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x13, 0x64, 0x61, 0x74, 0x61, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65, 0x12, 0x4d, 0x0a, 0x23, 0x74,
	...
	0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x20, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x65,
	0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0xd6, 0x01, 0x0a, 0x22, 0x54,
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x4e, 0x6f, 0x6e, 0x46, 0x75, 0x6e, 0x67, 0x69, 0x62,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x76,
	...
	,
	...
	,
	...
	0x6c, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x74, 0x78, 0x73, 0x79, 0x73,
	0x74, 0x65, 0x6d, 0x2f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x2f, 0x3b, 0x74, 0x6f, 0x6b, 0x65,
...
var file_token_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_token_tx_proto_goTypes = []interface{}{
	(*Icon)(nil), // 0: alphabill.tokens.v1.Icon
	(*CreateNonFungibleTokenTypeAttributes)(nil), // 1: alphabill.tokens.v1.CreateNonFungibleTokenTypeAttributes
	(*MintNonFungibleTokenAttributes)(nil),       // 2: alphabill.tokens.v1.MintNonFungibleTokenAttributes
	(*TransferNonFungibleTokenAttributes)(nil),   // 3: alphabill.tokens.v1.TransferNonFungibleTokenAttributes
	(*UpdateNonFungibleTokenAttributes)(nil),     // 4: alphabill.tokens.v1.UpdateNonFungibleTokenAttributes
	(*CreateFungibleTokenTypeAttributes)(nil),    // 5: alphabill.tokens.v1.CreateFungibleTokenTypeAttributes
	(*MintFungibleTokenAttributes)(nil),          // 6: alphabill.tokens.v1.MintFungibleTokenAttributes
	(*TransferFungibleTokenAttributes)(nil),      // 7: alphabill.tokens.v1.TransferFungibleTokenAttributes
	(*SplitFungibleTokenAttributes)(nil),         // 8: alphabill.tokens.v1.SplitFungibleTokenAttributes
	(*BurnFungibleTokenAttributes)(nil),          // 9: alphabill.tokens.v1.BurnFungibleTokenAttributes
	(*JoinFungibleTokenAttributes)(nil),          // 10: alphabill.tokens.v1.JoinFungibleTokenAttributes
	(*txsystem.Transaction)(nil),                 // 11: Transaction
	(*block.BlockProof)(nil),                     // 12: BlockProof
}
var file_token_tx_proto_depIdxs = []int32{
	0,  // 0: alphabill.tokens.v1.CreateNonFungibleTokenTypeAttributes.icon:type_name -> alphabill.tokens.v1.Icon
	0,  // 1: alphabill.tokens.v1.CreateFungibleTokenTypeAttributes.icon:type_name -> alphabill.tokens.v1.Icon
	11, // 2: alphabill.tokens.v1.JoinFungibleTokenAttributes.burn_transactions:type_name -> Transaction
	12, // 3: alphabill.tokens.v1.JoinFungibleTokenAttributes.proofs:type_name -> BlockProof
...
func file_token_tx_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_token_tx_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
