...
func TestExecutedBlock(t *testing.T) {
	...
	rootHash := []byte{0x5e, 0xdf, 0x18, 0xb3, 0x2d, 0x34, 0x48, 0x26, 0xfc, 0x73, 0x2b, 0x86, 0xcd, 0x77, 0x78, 0xe7, 0xac, 0x99, 0xf, 0xb8, 0x95, 0xc0, 0x7b, 0x49, 0x58, 0xf6, 0x24, 0xa7, 0xbd, 0x86, 0x84, 0x67}
...
func TestExecutedBlock_GenerateCertificates(t *testing.T) {
	block := &ExecutedBlock{
		...
		RootHash: []byte{0x51, 0x9D, 0xFD, 0xF8, 0x07, 0x68, 0xCC, 0x97, 0x12, 0x98, 0xA5, 0x9C, 0xE8, 0x93, 0x76,
			0x54, 0xD1, 0xDA, 0x09, 0x39, 0x2A, 0x19, 0xBB, 0xD7, 0x38, 0xA3, 0xED, 0x26, 0x60, 0xC2, 0xD8, 0x18},
	...
	commitQc = &drctypes.QuorumCert{
		...
		LedgerCommitInfo: &types.UnicitySeal{
			PreviousHash: []byte{0, 0, 0, 0},
			Hash: []byte{0x51, 0x9D, 0xFD, 0xF8, 0x07, 0x68, 0xCC, 0x97, 0x12, 0x98, 0xA5, 0x9C, 0xE8, 0x93, 0x76,
				0x54, 0xD1, 0xDA, 0x09, 0x39, 0x2A, 0x19, 0xBB, 0xD7, 0x38, 0xA3, 0xED, 0x26, 0x60, 0xC2, 0xD8, 0x18,
			},
		},
	}
