...
func (m *MockExecContext) GetUnit(id types.UnitID, committed bool) (state.VersionedUnit, error) {
	if m.mockErr != nil {
...
func WithUnit(unit state.VersionedUnit) TestOption {
	return func(m *MockExecContext) {
		m.Unit = unit
	}
}
