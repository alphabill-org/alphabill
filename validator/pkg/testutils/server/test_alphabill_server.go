...
func (s *TestAlphabillServiceServer) ProcessTransaction(_ context.Context, tx *alphabill2.Transaction) (*emptypb.Empty, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *TestAlphabillServiceServer) GetBlock(_ context.Context, req *alphabill2.GetBlockRequest) (*alphabill2.GetBlockResponse, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	...
	return &alphabill2.GetBlockResponse{Block: blockBytes}, nil
}
...
func (s *TestAlphabillServiceServer) GetBlocks(_ context.Context, req *alphabill2.GetBlocksRequest) (*alphabill2.GetBlocksResponse, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	...
	return &alphabill2.GetBlocksResponse{Blocks: blocks, MaxBlockNumber: s.maxBlockHeight}, nil
}

func (s *TestAlphabillServiceServer) GetRoundNumber(context.Context, *emptypb.Empty) (*alphabill2.GetRoundNumberResponse, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	return &alphabill2.GetRoundNumberResponse{RoundNumber: s.maxBlockHeight}, nil
}
...
func StartServer(alphabillService *TestAlphabillServiceServer) (*grpc.Server, net.Addr) {
	...
	alphabill2.RegisterAlphabillServiceServer(grpcServer, alphabillService)
	go func() {
