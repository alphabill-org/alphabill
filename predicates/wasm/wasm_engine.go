...
func (wr WasmRunner) Execute(ctx context.Context, p *predicates.Predicate, args []byte, sigBytes []byte, env exec.TxContext) (bool, error) {
	...
	code, err := wr.vm.Exec(ctx, p.Code, args, par, sigBytes, env)
	if err != nil {
