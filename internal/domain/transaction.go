...
// FromProtobuf creates new TransactionOrder from corresponding protobuf object.
// Does not copy all values. I.e. only array pointers are copied.
func FromProtobuf(pbTxOrder transaction.TransactionOrder) (*TransactionOrder, error) {
	// Validation
