...
func Test_requestStore_add(t *testing.T) {
	...
	require.ErrorContains(t, rs.add(&certification.BlockCertificationRequest{NodeIdentifier: "1", InputRecord: IR1}), "request in this round already stored, rejected")
	require.ErrorContains(t, rs.add(&certification.BlockCertificationRequest{NodeIdentifier: "1", InputRecord: IR2}), "request in this round already stored, rejected")
...
func Test_CertStore_add(t *testing.T) {
	...
	require.ErrorContains(t, cs.Add(&certification.BlockCertificationRequest{SystemIdentifier: SysID1, NodeIdentifier: "1", InputRecord: IR1}), "request in this round already stored, rejected")
	require.ErrorContains(t, cs.Add(&certification.BlockCertificationRequest{SystemIdentifier: SysID1, NodeIdentifier: "1", InputRecord: IR2}), "request in this round already stored, rejected")
