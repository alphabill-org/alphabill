...
build/alphabill wallet token new-type fungible --decimals 0 --symbol AB --type $typeId1 -u localhost:27766 --log-level DEBUG --log-file $abHome/wallet1/w1.log -l $abHome/wallet1/
...
build/alphabill wallet token new fungible --type $typeId1 --amount 1 --log-level DEBUG -l ~/.alphabill/wallet1/ --log-file $abHome/wallet1/w1.log -u localhost:27766
build/alphabill wallet token new fungible --type $typeId1 --amount 2 --log-level DEBUG -l ~/.alphabill/wallet1/ --log-file $abHome/wallet1/w1.log -u localhost:27766
build/alphabill wallet token new fungible --type $typeId1 --amount 5 --log-level DEBUG -l ~/.alphabill/wallet1/ --log-file $abHome/wallet1/w1.log -u localhost:27766
...
build/alphabill wallet token list fungible -u localhost:27766 --log-level DEBUG --log-file $abHome/wallet2/w2.log -l $abHome/wallet2/
