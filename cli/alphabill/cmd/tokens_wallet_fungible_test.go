...
func NewAlphabillNetwork(t *testing.T) *AlphabillNetwork {
	...
	tokenFeeManager := fees.NewFeeManager(am, unitLocker, money.DefaultSystemIdentifier, moneyWallet, moneyBackendClient, tokens.DefaultSystemIdentifier, tokenTxPublisher, tokenBackendClient, tokens.NewFeeCreditRecordID)
