...
func (m *Module) executeAddVarTx(tx *types.TransactionOrder, attr *orchestration.AddVarAttributes, exeCtx *txsystem.TxExecutionContext) (*types.ServerMetadata, error) {
	// try to update unit
