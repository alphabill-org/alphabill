...
func (n *NonFungibleTokensModule) validate(tx *types.TransactionOrder, attr *tokens.CreateNonFungibleTokenTypeAttributes, exeCtx *txsystem.TxExecutionContext) error {
	unitID := tx.UnitID()
